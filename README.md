...
Your working directory will be under git control. You will first copy (fork in git jargon)
this repository to your GitHub account, and then work on this new copy using it as your remote.
